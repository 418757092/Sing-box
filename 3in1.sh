...
USERNAME=$(whoami)
HOSTNAME=$(hostname)
export UUID=${UUID:-'83be876f-d004-403f-93fc-c305d8698899'}
...
cat > list.txt <<EOF
vless://$UUID@$IP:$vless_port?encryption=none&flow=xtls-rprx-vision&security=reality&sni=www.joom.com&fp=chrome&pbk=$public_key&type=tcp&headerType=none#$NAME-reality
